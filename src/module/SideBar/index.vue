    ...
    <div class="layui-side layui-bg-black">
      ...
      <div class="navBar layui-side-scroll" style="height: 514px;">
        <ul class="layui-nav layui-nav-tree">
          ...
          <li class="layui-nav-item">
            <router-link to="#"><i class="iconfont icon-text" data-icon="icon-text"></i><cite>用户列表</cite></router-link>
          </li>
          <li class="layui-nav-item">
            <router-link to="#"><i class="iconfont icon-text" data-icon="icon-text"></i><cite>修改密码</cite></router-link>
          </li>
        </ul>
      </div>
    </div>
